...
- Какую следующую подзадачу ты рекомендуешь решать: следующую, либо исправляем ошибки этой задачи, либо одновременно исправляем ошибки этой задачи и решаем следующую задачу?
- Какие тесты стоит прогнать, чтобы ты получил более полную картину? 
